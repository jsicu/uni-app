			...
			<view class="cu-progress" :style="{ left: areaLeft, 'flex-direction': flexDirection, width: areaW, height: areaH }">
				...
				>
					<movable-view
						...
						disabled="disabled"
						:animation="false"
						:style="{ top: handleT, width: handleS, height: handleS, 'border-radius': handleBR, 'background-color': handleColor }"
						@change="change"
						:damping="damping"
						:x="handleX"
						:y="handleY"
...
export default {
	...
	beforeMount: function() {
		...
		// console.log(this.showValue - this.minValue, this.maxValue - this.minValue)
